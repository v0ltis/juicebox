...
class ready():
	...
	async def boucle(self):
		while True:
			...
			await self.client.change_presence(game=discord.Game(name=serv_co,type=0))
			await asyncio.sleep(15)
			await self.client.change_presence(game=discord.Game(name="/help",type=0))
			await asyncio.sleep(15)
			await self.client.change_presence(game=discord.Game(name="juicebot.github.io",type=0))
			await asyncio.sleep(15)
